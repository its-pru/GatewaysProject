...
public class JDBC {
    ...
    public static final String DB_LOCATION = "jdbc:mysql://db.cs.ship.edu/swe400_23"; // jdbc:mysql://db.engr.ship.edu:3306/csc471_05?useTimezone=true&serverTimezone=UTC
